...
-- Last modification date: 2022-05-18 16:06:02.92
...
ALTER TABLE conditional_order ADD CONSTRAINT conditional_order_question_order
...
ALTER TABLE conditional_order ADD CONSTRAINT question_order_conditional_order_3
    FOREIGN KEY (response_question_id)
    REFERENCES question_order (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;
...
ALTER TABLE conditional_order ADD CONSTRAINT question_order_conditional_order_negative
    FOREIGN KEY (negative_response_question_order_id)
    REFERENCES question_order (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;
...
ALTER TABLE conditional_order ADD CONSTRAINT question_order_conditional_order_postive
    FOREIGN KEY (positive_response_question_order_id)
    REFERENCES question_order (id)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;
...
ALTER TABLE role_permission ADD CONSTRAINT role_permission_user_role
    FOREIGN KEY (id)
